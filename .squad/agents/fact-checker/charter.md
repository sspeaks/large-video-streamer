...
Self-hosted, auth-gated HLS streaming web app (Go 1.22 + Nix/NixOS + FFmpeg + SQLite). Primary goal: autonomous detection and labeling of barbershop-competition performances within large videos, with measurable accuracy benchmarks and per-performance share links. User: Seth Speaks.
